...
public class HelloController {
    ...
    final private String apiUrl = "http://api.exchangeratesapi.io/v1/latest?access_key=8e8dac7fabb2d29d97e023c47b05b88b";
    ...
    public String index() {
        try {
            ...
            ExchangeResponse result = mapper.readValue(testJson, ExchangeResponse.class);
            if (!result.isSuccess())
                return "No response from exchange server";

            String str = "";

            for (Map.Entry<String, Double> entry : result.getRates().entrySet()) {
